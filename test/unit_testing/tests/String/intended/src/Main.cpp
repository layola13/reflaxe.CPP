...
void Main::main() {
	...
	Main::assert((int)(str.find("es"s)) == 1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 26, "main"s));
	Main::assert((int)(str.find("Hey"s)) == -1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 27, "main"s));
	Main::assert((int)(str.find("Te"s, (std::size_t)(2))) == -1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 28, "main"s));
	Main::assert((int)(str.rfind("Te"s)) == 0, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 30, "main"s));
	...
	if(12 < 0) {
		tempString = str2.substr(7);
	} else {
		tempString = str2.substr(7, 12 - 7);
	};

	Main::assert((tempString) == "World"s, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 40, "main"s));
	...
	if((0 < 0) || (0 >= (int)(toolsStr.size()))) {
		...
		tempNumber = toolsStr.at(0);
	};

	Main::assert((tempNumber) == 72, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 51, "main"s));
	...
	if((99 < 0) || (99 >= (int)(toolsStr.size()))) {
		...
		tempNumber1 = toolsStr.at(99);
	};

	Main::assert((tempNumber1) == -1, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/String/Main.hx"s, 52, "main"s));
