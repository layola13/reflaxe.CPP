...
namespace haxe {
	template<> struct _class<std::string> {
		DEFINE_CLASS_TOSTRING
		using Dyn = haxe::Dynamic_std_string;
		constexpr static _class_data<17, 1> data {
			"String",
			{ "length", "indexOf", "substr", "lastIndexOf", "charAt", "toString", "charCodeAt", "toUpperCase", "toLowerCase", "split", "substring", "c_str", "data", "at", "length_type", "indexOf_type", "lastIndexOf_type" },
			{ "fromCharCode" },
			true
			};
	};
