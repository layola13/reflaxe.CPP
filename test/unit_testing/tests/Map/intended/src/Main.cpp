...
void Main::main() {
	...
	std::shared_ptr<haxe::ds::IntMap<int>> intMap2 = tempMap->copyOG();

	tempMap->set(2, 222);
	Main::assert(tempMap->get(1) == 123, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 22, "main"s));
	Main::assert(tempMap->get(2) == 222, haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 23, "main"s));
	Main::assert(tempMap->exists(1), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 25, "main"s));
	Main::assert(tempMap->exists(2), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 26, "main"s));
	Main::assert(!tempMap->exists(3), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 27, "main"s));
	tempMap->set(3, 333);
	Main::assert(tempMap->exists(3), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 30, "main"s));
	Main::assert(tempMap->remove(3), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 31, "main"s));
	Main::assert(!tempMap->remove(3), haxe::shared_anon<haxe::PosInfos>("Main"s, "test/unit_testing/tests/Map/Main.hx"s, 32, "main"s));

	int sum = 0;
	std::shared_ptr<Iterator<int>> k = tempMap->keys();
	...
	{
		std::shared_ptr<haxe::IMap<int, int>> map = tempMap;
